...
date: "2019-06-12"
permalink: "/2019/06/il-voto-per-le-europee-a-milano/"
categories: 
...
{% include image.html url="/assets/images/milano_1994_2019-1-1024x640.png" description="Voti assegnati ai partiti nelle elezioni europee del 1994 e 2019." %}
...
{% include image.html url="/assets/images/degree_over65-1-1024x731.png" description="Percentuale di residenti laureati a Milano e nel resto d Italia secondo i dati censimentari." %}
...
{% include image.html url="/assets/images/degree_over65_census-1-1024x427.png" description="Percentuale di laureati tra la popolazione residente secondo i dati censimentari per sezione di censimento." %}
...
{% include image.html url="/assets/images/Lega_vs_PD-1-1024x731.png" description="Distribuzione del voto per le europee 2019 tra Lega e PD a livello di numero civico." %}
...
{% include image.html url="/assets/images/nuclei_voti_pct-1-1024x683.png" description="Distribuzione del voto per le europee 2019 tra Lega e PD a livello di numero civico." %}
...
{% include image.html url="/assets/images/nuclei_voti_vs-1-1024x853.png" description="Distribuzione del voto per le europee 2019 a livello di nucleo d’identità locale." %}
...
{% include image.html url="/assets/images/valori_abitazioni-1-1024x731.png" description="Volore medio minimo per metro quadro di abitazioni in compravendita calcolato in 41 zone di Milano sulla base di dati curati dall’Agenzia delle Entrate." %}
...
{% include image.html url="/assets/images/unnamed-chunk-4-1-1024x731.png" description="Associazione del voto alla Lega alle europee 2019 e il valore delle abitazioni." %}
